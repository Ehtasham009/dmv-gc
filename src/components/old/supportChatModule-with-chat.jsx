...
const  SupportChatModule = forwardRef((props, ref) => {
    ...
    return (
        <StyledCom className='chat-support-module'>
            <div className='chat-support questions-screen-active'>
                <div className='h-list support-header'>
                    <span>Let's Chat</span>
                    <div className="icon-rounded" onClick={() => { chatModulePopupClose(); setShowScreen('QuestionsAnsScreen'); }}>
                        X
                    </div>
                </div>
