  ...
  return (
    <StyledCom className={`h-list justify-content-between ${headerClassName}`}>
        ...
        <div className='chat-support-module-holder'>
            <SupportChatModule ref={chatModuleRef} />
            <div className='h-list justify-content-center chat-support-button' onClick={() => { chatModulePopupOpen();  startChatSupport();}}>
                <div className='arrow-holder'>
