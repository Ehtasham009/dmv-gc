  ...
  return (
    <StyledCom >
        ...
        <div className='h-list justify-content-between sub-footer'>
            ...
            <div className='h-list' data-gap="15">
                <Link target='_blank' to="https://www.facebook.com/DMVGCGroupLLC" className='icon-rounded icon-item'>
                ...
                <Link target='_blank' to="https://www.linkedin.com/company/dmv-general-contracting-group-llc" className='icon-rounded icon-item'>
                ...
                <Link target='_blank' to="https://www.instagram.com/dmvgcgroupllc" className='icon-rounded icon-item'>
                ...
                {/* <Link target='_blank' to="/" className='icon-rounded icon-item'>
